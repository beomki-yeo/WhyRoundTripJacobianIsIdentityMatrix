...
\newcommand{\jacobianCorrectionFinalExpansionPerigee}{    \begin{pmatrix}[1.3]
     \IdentityMatrixThree - \frac{1}{1 - \globalDirection \cdot \vbasis}\globalDirection (\globalDirection - (\globalDirection \cdot \vbasisFinal)\vbasisFinal)^{\textrm{T}} & -\frac{1}{1 - \globalDirection \cdot \vbasis} \globalDirection (l_{0\texttt{f}}\ubasisFinal)^{\textrm{T}} & \zeroMatrix  \\
     - \frac{1}{1 - \globalDirection \cdot \vbasis}\qoverp (\globalDirection \times \bfield) (\globalDirection - (\globalDirection \cdot \vbasisFinal)\vbasisFinal)^{\textrm{T}} &  \IdentityMatrixThree -\frac{1}{1 - \globalDirection \cdot \vbasis} \qoverp (\globalDirection \times \bfield) (l_{0\texttt{f}}\ubasisFinal)^{\textrm{T}} &
     \zeroMatrix \\
     \zeroMatrix & 
     \zeroMatrix &  1
    \end{pmatrix}
